...
class ResNet(nn.Module):
    ...
    def forward(self, x): # 2 3 224 224
        ...
        # x = self.relu(self.bn1(self.conv1(x))) # 2 128 112 112
        # x = self.maxpool(x) # 2 128 57 57
        ...
        x4 = self.layer4(x3)
        if self.fpn:
            return [x1, x2, x3, x4]  # 2 256 97 97  #2 512 49 49    #2 1024 49 49   #2 2048 49 49   
        else:
            return [x3, x4]
